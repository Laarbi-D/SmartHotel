...
<body>
  ...
  <div class="layout">
    ...
    <aside class="sidebar">
      ...
      <a href="login.html" class="nav-item nav-item--logout" onclick="return confirm('Se déconnecter ?')">
    ...
    <div class="main-wrapper">
      ...
      <header class="header">
        <div class="header__search">
          ...
          <input type="text" id="order-search" placeholder="Search customer..."/>
        </div>
      ...
      <!-- CONTENT -->
      <main class="main">
        <h1 class="dashboard-title">Order</h1>
